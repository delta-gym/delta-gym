...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-sidebar text-sidebar-text h-screen sticky top-0 flex flex-col shadow-2xl shrink-0">
      {/* Logo */}
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-primary flex items-center justify-center text-white font-bold text-lg shadow-lg">
            {config?.nombre ? config.nombre.charAt(0).toUpperCase() : 'G'}
          </div>
          <div className="overflow-hidden">
            <h1 className="text-base font-bold leading-tight truncate" title={config?.nombre || 'Gimnasio Delta'}>
              {config?.nombre || 'Gimnasio Delta'}
            </h1>
            <p className="text-xs opacity-50">Panel Admin</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs opacity-50 truncate">admin@delta.cl</p>
          </div>
        </div>
      </div>
    </aside>
